...
Go to the latest release ([v1.1](https://github.com/Cryptix/cryptix-stratum-bridge/releases/tag/v1.1) at the time of writing) and download the source code. Download the zip archive for windows, tar.gz for everything else.
...
- cpay_bridge is running on port :5555
