...
func TestNewClient(t *testing.T) {
	...
	event, _ := json.Marshal(NewEvent("1", "mining.authorize", []any{
		"qqkrl0er5ka5snd55gr9rcf6rlpx8nln8gf3jxf83w4dc0khfqmauy6qs83zm", "test",
	}))
...
func TestWalletValidation(t *testing.T) {
	tests := []struct {
		...
		{
			in:       "cryptix:qqayxgcjfh6d7uxpj4w3qzjvx73vdehfx22fl6cacmn44rpj5geg2rxyuhga4,Rig_3784816",
			expected: "cryptix:qqayxgcjfh6d7uxpj4w3qzjvx73vdehfx22fl6cacmn44rpj5geg2rxyuhga4",
		},
		{
			in:       "cryptix:qqkrl0er5ka5snd55gr9rcf6rlpx8nln8gf3jxf83w4dc0khfqmauy6qs83zm,Rig_3784816",
			expected: "cryptix:qqkrl0er5ka5snd55gr9rcf6rlpx8nln8gf3jxf83w4dc0khfqmauy6qs83zm",
		},
		{
